...
$string['missingactivitiessettings'] = 'Missing activities thresholds';
$string['missingactivitiessettingsdesc'] = 'Configure the thresholds for missing activities-based risk detection';
$string['missingactivitiesthreshold1'] = 'Level 1 threshold (activities)';
$string['missingactivitiesthreshold1_desc'] = 'Number of missing activities for medium risk (default: 1)';
$string['missingactivitiesthreshold2'] = 'Level 2 threshold (activities)';
$string['missingactivitiesthreshold2_desc'] = 'Number of missing activities for high risk (default: 3)';
$string['missingactivitiesthreshold3'] = 'Level 3 threshold (activities)';
$string['missingactivitiesthreshold3_desc'] = 'Number of missing activities for critical risk (default: 5)';
$string['missingactivities'] = 'Missing activities';
...
$string['channelmoodle'] = 'Enable Moodle messaging';
$string['channelmoodle_desc'] = 'Send alerts via Moodle direct messaging';
...
$string['emailsendersettings'] = 'Email sender';
$string['emailsendersettingsdesc'] = 'Configure the sender address and name used for automatic email notifications';
$string['notificationfromemail'] = 'From email address';
$string['notificationfromemail_desc'] = 'Email address used as the sender for automatic notifications. Leave empty to use the Moodle no-reply address';
$string['notificationfromname'] = 'From name';
$string['notificationfromname_desc'] = 'Display name used as the sender for automatic notifications (only applied if a from email address is set)';
...
$string['triggercriterion'] = 'Triggering criterion';
$string['trigger_inactivity'] = 'Inactivity';
$string['trigger_activities'] = 'Missing activities';
$string['trigger_both'] = 'Inactivity & activities';
...
$string['assignment_reminder_7days'] = 'Assignment reminder (D-7)';
$string['assignment_reminder_1day'] = 'Assignment reminder (D-1)';
$string['institutional_announcement'] = 'Institutional announcement';
...
$string['recipients_category'] = 'All students in a category';
$string['recipients_all_course'] = 'All course';
$string['recipients_group'] = 'Specific group';
$string['recipients_manual'] = 'Manual selection';
$string['recipients_csv'] = 'Import from CSV file';
$string['csvfile'] = 'Recipients CSV file';
$string['csvfile_help'] = 'Upload a CSV file containing recipient emails, usernames, or IDs. Format: one recipient per line. Example:<br>email@example.com<br>username123<br>12345';
$string['csvfilerequired'] = 'Please upload a CSV file';
...
$string['missingassignments'] = 'Missing activities';
...
$string['alertsqueued'] = '{$a} alert(s) queued for background delivery.';
...
$string['selectusersfield'] = 'Select users';
...
$string['filterbymissingassignments'] = 'Filter by missing activities';
...
$string['escalationmessage'] = 'Student {$a->studentname} is in critical situation (Level: {$a->risklevel}). Inactivity: {$a->inactivity} days, Missing activities: {$a->missing}.';
